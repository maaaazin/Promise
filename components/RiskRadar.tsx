    ...
    <section className="rounded-md border border-slate-300 bg-white dark:border-white/10 dark:bg-transparent">
      <div className="border-b border-slate-300 p-4 sm:px-5 dark:border-white/10">
        <div className="flex items-baseline justify-between">
          <h2 className="text-base font-semibold text-slate-900 dark:text-slate-200">Commitment radar</h2>
          <span className="font-mono text-xs text-slate-500 dark:text-slate-400">{commitments.length} signals tracked</span>
        </div>
      </div>
